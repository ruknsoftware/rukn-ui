<template>
  <button
    ...
    class="flex w-full items-center rounded-xl px-2 py-1.5 text-label-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
    :class="
      disabled
