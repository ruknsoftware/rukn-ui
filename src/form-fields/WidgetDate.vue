...
input[type='date']:dir(ltr)::-webkit-calendar-picker-indicator {
  position: absolute;
  right: 0.75rem;
}
input[type='date']:dir(rtl)::-webkit-calendar-picker-indicator {
  position: absolute;
  left: 0.75rem;
}

/* The day/month/year segment cluster also ignores dir="rtl" and stays
